...
//
//  Created by Sugeet-Home on 08/08/18.
//
...
extension Array where Element: BaseNetworkModel {
	...
	*/
	func toJson(_ prettyPrinted: Bool = false) -> Data? {
...
extension Mirror {
	...
	func formatValue(_ value: Any?, forKey: String) -> Any? {
		return value
	}
	...
	*/
	func toJson1(_ prettyPrinted: Bool = false) -> Data? {
